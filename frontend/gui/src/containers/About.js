        ...
        <div id="all">
            <div className="container-fluid">
                <div className="row row-offcanvas row-offcanvas-left"> 
                    <Sidebar />
                    <div className="col-md-8 col-lg-9 content-column white-background">
                        <Menu />
                        <div className="row">
                            <div className="col-xl-10">
                                <div className="content-column-content">
                                    <h1>About me</h1>
                                    <p className="lead">An sincerity so extremity he additions. Her yet <strong>there truth merit</strong>. Mrs all projecting favourable now unpleasing. Son law garden chatty temper. Oh children provided to mr elegance marriage strongly. Off can admiration prosperous now devonshire diminution law.</p>
                                    <div className="row">
